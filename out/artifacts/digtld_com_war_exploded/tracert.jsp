...
<div class="container">
  ...
  <div class="table">
    ...
    This page will work only in Microsoft Internet Explorer because of ActiveX!<br>
<br>
    Also it will work only if you'll add this site to trusted and allow it to run scripts.<br>
<br>
    You can download .REG file with required parameters (it'll add this site to trusted and allow it to run ActiveX objects):

     <a href="https://www.digtld.com/activex_allow_IE.reg">Download</a><br>

  <input id="domain">
 <button onclick="runapp();" type="button" class="btn-primary" >Run traceroute </button>
